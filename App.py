...
st.caption('''Este projeto utiliza a biblioteca Prophet para prever os níveis de ozônio em ug/m3. O modelo
           criado foi treinado com dados até o dia 05/05/2023 e possui um erro de previsão (RMSE - Erro Quadrático Médio) igual a 18.74 nos dados de teste.
...
if st.session_state.previsao_feita:
    ...
    st.write('Tabela contendo as previões de ozônio (ug/m3) para os próximos {} dias:'.format(dias))
